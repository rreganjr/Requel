/*
 * $Id: JpaDictionaryRepository.java,v 1.7 2009/03/27 07:16:08 rregan Exp $
...
public class JpaDictionaryRepository extends AbstractJpaRepository implements DictionaryRepository {
	 ...
	 */
	public static final String PROP_ENGLISH_DICTIONARY_FILES_DEFAULT = "resources/nlp/jazzy/eng_com.dic|"
	...
	public List<String> findSpellingSuggestions(String word, int threshold) {
		...
		for (Object obj : getSpellChecker().getSuggestions(word, threshold)) {
			com.swabunga.spell.engine.Word jazzyWord = (com.swabunga.spell.engine.Word) obj;
