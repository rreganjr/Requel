/*
 * $Id: StanfordLexicalizedParser.java,v 1.3 2009/01/28 10:18:45 rregan Exp $
...
public class StanfordLexicalizedParser implements NLPProcessor<NLPText> {
	 ...
	 * default the path is "resources/nlp/stanford-parser/englishPCFG.ser.gz"
	 */
	 ...
	 */
	public static final String PROP_PARSER_FILE_DEFAULT = "resources/nlp/stanford-parser/englishPCFG.ser.gz";
	...
	private static synchronized void parse(NLPText text) throws ParserException {
		...
		if (parser.parse(tokens)) {
			...
			copyStanfordTreeToNLPText((NLPTextImpl) text, stanfordTree, stanfordTree.getLeaves(),
					new Counter());
