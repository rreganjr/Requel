...
public class GoalSelectorPanel extends SelectorTablePanel {
	private static final Logger log = Logger.getLogger(GoalSelectorPanel.class);
	...
	public String getTitle() {
		return getResourceBundleHelper(getLocale()).getString(PROP_PANEL_TITLE, "Select Goal");
	}
