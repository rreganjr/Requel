...
import net.sf.echopm.panel.editor.tree.AbstractEditorTreeNodeFactory;
...
public class ScenarioStepEditorTreeNodeFactory extends AbstractEditorTreeNodeFactory {
	private static final Log log = LogFactory.getLog(ScenarioStepEditorTreeNodeFactory.class);
