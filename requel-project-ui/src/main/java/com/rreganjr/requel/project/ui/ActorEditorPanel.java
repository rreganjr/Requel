...
public class ActorEditorPanel extends AbstractRequelProjectEditorPanel {
	private static final Log log = LogFactory.getLog(ActorEditorPanel.class);
	...
	public String getTitle() {
		if (getActor() != null) {
			String msgPattern = getResourceBundleHelper(getLocale()).getString(
					...
					getResourceBundleHelper(getLocale()).getString(Panel.PROP_PANEL_TITLE, "Actor: {0}"));
			...
			String msg = getResourceBundleHelper(getLocale()).getString(
					...
					getResourceBundleHelper(getLocale()).getString(Panel.PROP_PANEL_TITLE, "New Actor"));
			return msg;
		}
	}
