...
public class StorySelectorPanel extends SelectorTablePanel {
	private static final Log log = LogFactory.getLog(StorySelectorPanel.class);
	...
	public String getTitle() {
		return getResourceBundleHelper(getLocale()).getString(Panel.PROP_PANEL_TITLE, "Select Story");
	}
