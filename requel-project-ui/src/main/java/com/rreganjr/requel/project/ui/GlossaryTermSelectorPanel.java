...
public class GlossaryTermSelectorPanel extends SelectorTablePanel {
	private static final Log log = LogFactory.getLog(GlossaryTermSelectorPanel.class);
	...
	public String getTitle() {
		return getResourceBundleHelper(getLocale()).getString(Panel.PROP_PANEL_TITLE, "Select Term");
	}
