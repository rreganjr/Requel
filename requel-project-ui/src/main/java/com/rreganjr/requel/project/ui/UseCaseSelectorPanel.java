...
public class UseCaseSelectorPanel extends SelectorTablePanel {
	private static final Log log = LogFactory.getLog(UseCaseSelectorPanel.class);
	...
	public String getTitle() {
		return getResourceBundleHelper(getLocale()).getString(Panel.PROP_PANEL_TITLE, "Select Use Case");
	}
