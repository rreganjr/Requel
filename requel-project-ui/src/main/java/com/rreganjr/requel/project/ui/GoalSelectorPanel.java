...
public class GoalSelectorPanel extends SelectorTablePanel {
	private static final Log log = LogFactory.getLog(GoalSelectorPanel.class);
	...
	public String getTitle() {
		return getResourceBundleHelper(getLocale()).getString(Panel.PROP_PANEL_TITLE, "Select Goal");
	}
