...
public class GoalNavigatorPanel extends NavigatorTablePanel {
	private static final Log log = LogFactory.getLog(GoalNavigatorPanel.class);
	 ...
	 */
	public static final String PROP_EDIT_GOAL_BUTTON_LABEL = "EditGoalButton.Label";
	 ...
	 */
	public static final String PROP_VIEW_GOAL_BUTTON_LABEL = "ViewGoalButton.Label";
	...
	public String getTitle() {
		String name = "";
		String msgPattern = getResourceBundleHelper(getLocale()).getString(Panel.PROP_PANEL_TITLE,
				"Goals: {0}");
	...
	public void setup() {
		...
		String closeButtonLabel = getResourceBundleHelper(getLocale()).getString(
				Panel.PROP_CANCEL_BUTTON_LABEL, "Close");
		...
		NavigatorButton closeButton = new NavigatorButton(closeButtonLabel, getEventDispatcher(),
				closeEvent);
		closeButton.setStyleName(Panel.STYLE_NAME_DEFAULT);
		buttonsWrapper.add(closeButton);

		if (!isReadOnlyMode()) {
			String newGoalButtonLabel = getResourceBundleHelper(getLocale()).getString(
					PROP_NEW_GOAL_BUTTON_LABEL, "Add");
			NavigationEvent openGoalEditor = new OpenPanelEvent(this, PanelActionType.Editor,
					getProjectOrDomain(), Goal.class, null, WorkflowDisposition.NewFlow);
			NavigatorButton newGoalButton = new NavigatorButton(newGoalButtonLabel,
					getEventDispatcher(), openGoalEditor);
			newGoalButton.setStyleName(Panel.STYLE_NAME_DEFAULT);
