...
public class ImportProjectCommandImpl extends AbstractEditProjectCommand implements
	...
	public void execute() {
		try {
			...
			try {
				...
				AbstractRepositoryCommand.log.warn("The assistant user doesn't exist and could not "
	...
	private void addBuiltinReportGenerator(Project project, User user) {
		try {
			...
			AbstractRepositoryCommand.log.error("The builtin report generator could not be added to " + project, e);
		}
	}
}
