...
public class StakeholderPermissionsInitializer extends AbstractSystemInitializer {
	...
	public void initialize() {
		AbstractSystemInitializer.log.debug("update stakeholder permissions...");
		for (StakeholderPermission permission : getPermissionTypes()) {
			try {
				...
				AbstractSystemInitializer.log.debug(permission + " is already persistent.");
			} catch (EntityException e) {
				AbstractSystemInitializer.log.debug("creating: " + permission);
