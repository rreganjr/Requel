...
public class GenerateReportCommandImpl extends AbstractProjectCommand implements
	...
	public void execute() {
		try {
			...
			try {
				...
				AbstractRepositoryCommand.log.warn("The parser does not support XML validation.");
			}
			...
			AbstractRepositoryCommand.log.error(e, e);
		}
	}
	...
	private class AnErrorListener implements ErrorListener {
		public void warning(TransformerException e) throws TransformerException {
			// only log warnings
			AbstractRepositoryCommand.log.warn("Parser warning:  " + e.getMessage());
		}

		public void error(TransformerException e) throws TransformerException {
			AbstractRepositoryCommand.log.error("Parsing error:  " + e.getMessage());
			throw e;
		}

		public void fatalError(TransformerException e) throws TransformerException {
			AbstractRepositoryCommand.log.error("Fatal parsing error:  " + e.getMessage());
			throw e;
		}
	}
}
