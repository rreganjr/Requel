...
public class ReportGeneratorImportDraft {
    ...
    public static final class Builder {
        ...
        public ReportGeneratorImportDraft build() {
            Objects.requireNonNull(name, "report generator name is required");
            return new ReportGeneratorImportDraft(this);
        }
    }
}
