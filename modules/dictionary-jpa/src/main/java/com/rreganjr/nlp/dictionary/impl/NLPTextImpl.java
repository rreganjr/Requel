 ...
 *
 */
package com.rreganjr.nlp.dictionary.impl;
...
public class NLPTextImpl implements NLPText, Comparable<NLPText> {
	 ...
	 * @param parseTag
	 */
	public NLPTextImpl(NLPText parent, ParseTag parseTag) {
		setParent(parent);
	...
	public NLPTextImpl(NLPText parent, int wordIndex, String text, ParseTag parseTag) {
		setParent(parent);
	...
	public void setParent(NLPText parent) {
		this.parent = parent;
	}
	...
	public void setGrammaticalStructureLevel(GrammaticalStructureLevel grammaticalStructureLevel) {
	...
	public void addGovernorOf(GrammaticalRelation relation) {
	...
	public void addDependentOf(GrammaticalRelation relation) {
