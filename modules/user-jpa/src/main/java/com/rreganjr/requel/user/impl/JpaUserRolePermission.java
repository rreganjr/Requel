...
public class JpaUserRolePermission implements UserRolePermission {
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof JpaUserRolePermission otherJpa) {
			if ((getId() != null) && getId().equals(otherJpa.getId())) {
				return true;
			}
		}
	...
	public int compareTo(UserRolePermission o) {
		if (o instanceof JpaUserRolePermission otherJpa) {
			if ((getId() != null) && getId().equals(otherJpa.getId())) {
				return 0;
			}
		}
