...
/**
 * Default {@link RedactionPolicy} — passes every value through unchanged.
 * Replace by registering a project-aware {@code RedactionPolicy} bean before
 * enabling external AI.
 */
@Component
@ConditionalOnMissingBean(RedactionPolicy.class)
