...
public class ScenarioImpl extends StepImpl implements Scenario {
	...
	// hack Hibernate can't find projectOrDomain through inheritence but needs
	// them for "mappedBy"
	// for AbstractProjectOrDomainEntity.scenarios
	@Override
	@XmlTransient
	@ManyToOne(targetEntity = AbstractProjectOrDomain.class, cascade = { CascadeType.PERSIST,
