...
public class StorySelectorPanel extends SelectorTablePanel {
	private static final Logger log = Logger.getLogger(StorySelectorPanel.class);
	...
	public String getTitle() {
		return getResourceBundleHelper(getLocale()).getString(PROP_PANEL_TITLE, "Select Story");
	}
