/*
 * $Id: GlossaryTermNavigatorPanel.java,v 1.2 2009/02/22 09:07:22 rregan Exp $
...
public class GlossaryTermNavigatorPanel extends NavigatorTablePanel {
	private static final Logger log = Logger.getLogger(GlossaryTermNavigatorPanel.class);
