...
public class UseCaseSelectorPanel extends SelectorTablePanel {
	private static final Logger log = Logger.getLogger(UseCaseSelectorPanel.class);
	...
	public String getTitle() {
		return getResourceBundleHelper(getLocale()).getString(PROP_PANEL_TITLE, "Select Use Case");
	}
