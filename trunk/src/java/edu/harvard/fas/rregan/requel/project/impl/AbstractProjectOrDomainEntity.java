/*
 * $Id: AbstractProjectOrDomainEntity.java,v 1.50 2009/03/05 08:50:46 rregan Exp $
...
public abstract class AbstractProjectOrDomainEntity implements ProjectOrDomainEntity, Serializable {
	...
	@XmlTransient
	@ManyToOne(targetEntity = AbstractProjectOrDomain.class, cascade = { CascadeType.REFRESH }, optional = false)
