...
public class DomainObjectWrappingAdvice {
	protected static final Log log = LogFactory.getLog(DomainObjectWrappingAdvice.class);
	 ...
	 * @throws Throwable
	 */
	@Around(value = "execution(* AbstractJpaRepository+.*(..)) || execution(* com.rreganjr.command.Command+.get*(..))")
