...
public class OpenNLPTagger extends OpenNLPTokenizer {
	 ...
	 */
	public static final String PROP_POSTAGGER_DICTIONARY_FILE_DEFAULT = "nlp/opennlp-tools/parser/tagdict";
	...
	protected static class Tagger extends POSTaggerME implements POSTagger {

		private Tagger(MaxentModel mod, POSContextGenerator cg, TagDictionary dict) {
			super((AbstractModel)mod, cg, dict);
		}

		public Sequence[] topKSequences(List sentence) {
			return beam.bestSequences(10, (String[])sentence.toArray(), null);
		}
