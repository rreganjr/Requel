...
# project board.
#
# Issue bodies are sliced from doc/work/backlog/living-document-model-gaps.md (the canonical spec)
...
SPEC="$REPO_DIR/doc/work/backlog/living-document-model-gaps.md"
