...
7. **This plan moves itself.** `doc/304-doc-reorg-plan.md` is a ticket-scoped artifact and lands
...
- For every `*.md` under `doc/`, plus `CLAUDE.md`, `README.md` and anything under `scripts/`,
  ...
  - doc-relative (links between docs, e.g. `[…](AUTH_ARCH.md)`) → the correct `../` prefix for
...
`doc/304-doc-reorg-plan.md` → `doc/work/2.0/304-doc-reorg-plan.md`, in the same commit. It is
...
- **`post-124-ui-rollup.md` was clobbered, and it has broken a script since 2026-08-31.**
  ...
  ```bash
  git show ab53fa95:doc/post-124-ui-rollup.md > doc/post-124-ui-rollup.md
