...
This document describes how authorization works in the current Requel system and how it will be adapted for the new CQRS API architecture (see `doc/work/2.0/UI_REFACTOR_PLAN.md`).
