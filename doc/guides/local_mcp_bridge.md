...
> Draft design doc for a set of related issues. Builds on `doc/work/2.0/assistant-spi-plan.md`,
> `doc/work/2.0/ai-assistance-plan.md`, and the existing `mcp-server` module.
