...
- `doc/work/2.0/ai-assistance-plan.md` — overall AI‑assistance architecture (provider layer, context packs).
- `doc/architecture/AUTH_ARCH.md` — how `/api/**` authorization works.
