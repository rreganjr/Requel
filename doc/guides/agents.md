...
- Data boundaries: keep domain code persistence-ignorant—no repository access from entity constructors or JAXB hooks (see `doc/architecture/unmarshalling_plan.md`).
- Style boundaries: follow the DDD terminology and aggregate boundaries described in `doc/architecture/unmarshalling_plan.md`.
