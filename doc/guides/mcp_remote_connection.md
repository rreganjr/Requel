...
- **OAuth 2.1 (preferred for interactive clients — Codex, Claude Code, Claude Desktop/Cowork).**
  ...
  enable the AS + register a client) is in `doc/work/2.0/83-oauth-verification.md`.
...
**Enabling and client registration** are covered step-by-step in `doc/work/2.0/83-oauth-verification.md`.
...
`doc/work/2.0/83-oauth-verification.md`; PATs remain the headless/CI path.
