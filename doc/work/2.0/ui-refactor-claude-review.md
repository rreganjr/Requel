...
This document reviews [doc/work/2.0/UI_REFACTOR_PLAN.md](UI_REFACTOR_PLAN.md) for gaps and suggests additions. It focuses on: environment and versions, Echo2 vs Angular behavior, authentication/authorization (Spring Security and Angular), and token handling.
