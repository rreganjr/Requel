...
`doc/work/2.0/post-124-ui-punch-list.md` (items L1–L8, T2–T3, S1, D1, F1, A1, B1–B2) and planned in
`doc/work/2.0/post-124-ui-epic-plan.md`. Closed sub-issues are auto-checked; the rest are checked as
