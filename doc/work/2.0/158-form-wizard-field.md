...
Part of the look-and-feel adoption epic #124 (see `doc/work/2.0/124-lookandfeel-plan.md`, item N5),
and §1.2 "Form wizard" of `doc/work/2.0/UI_UX_REVIEW.md`. Phase 3. Concretizes #132 + #146.
...
This plan supersedes the N5 wording in `doc/work/2.0/124-lookandfeel-plan.md` §4 and the current
...
## 4. Replacement for `doc/work/2.0/124-lookandfeel-plan.md` §4, N5
...
>
> Part of the design-system adoption in `doc/work/2.0/124-lookandfeel-plan.md` §4 (N5) and §1.2
> "Form wizard". Full plan: `doc/work/2.0/158-form-wizard-field.md`. Phase 3. Concretizes #132 +
> #146.
>
> ### Why
>
...
- Update `doc/work/2.0/124-lookandfeel-plan.md` §4 N5 with §4 above, and the §7 points line
  (`N5 = 8` → `N5 = 13`).
