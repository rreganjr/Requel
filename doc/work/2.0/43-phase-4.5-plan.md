...
Issue #43. This phase exists because the review in `doc/work/2.0/43-opus48-review.md` found that
...
The plans this phase implements against: `doc/work/2.0/assistant-spi-plan.md`,
`doc/work/2.0/ai-assistance-plan.md`, `doc/work/2.0/nlp-optional-plan.md`. Contract/structural prep already
...
- Map every `AnnotationAction.ActionType` to the factory method per the command-mapping
  table in `doc/work/2.0/assistant-spi-plan.md`, selecting lexical / change-spelling / add-word
...
- Create the `assistant-legacy-nlp` module (per `doc/work/2.0/assistant-spi-plan.md` Target Module
...
- Implement the transitions owned by the applicator per `doc/work/2.0/assistant-spi-plan.md`
...
### 7. NLP-optional Scope 1 (`doc/work/2.0/nlp-optional-plan.md`)
...
### 8. MCP authentication + dual identity (`doc/work/2.0/ai-assistance-plan.md`)
