...
re-runs reconcile instead of duplicating. Companion to the design in `doc/guides/local_mcp_bridge.md` and
the implementation plan in `doc/work/2.0/71-issue-tracker-goals-plan.md` (issue #71).
