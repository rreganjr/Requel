...
`release/2.0`. Background: `doc/work/2.0/port-tospring-boot-ai.md` (and its codex review).
...
- **Blocks:** the Spring AI provider-client port (`doc/work/2.0/issue_spring_ai_provider_clients.md`) and
