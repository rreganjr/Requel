...
- Source finding: `doc/work/2.0/UI_UX_REVIEW.md` §1.3 — "Typography and hierarchy are too flat"
- Target look-and-feel: `doc/work/2.0/124-lookandfeel-plan.md`
- Phase order: `doc/work/2.0/124-remediation-rollup.md` — Phase 2 (design-system foundation)
...
Part of the UI/UX remediation epic (#124). Source: `doc/work/2.0/UI_UX_REVIEW.md` Finding 1.3.
Scope refinement: `doc/work/2.0/127-typography-rescope.md`.
...
`doc/work/2.0/127-typography-rescope.md` §2.
