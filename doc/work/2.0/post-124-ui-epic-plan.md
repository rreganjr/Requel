...
`doc/work/2.0/post-124-ui-punch-list.md` (items L1–L8, T2–T3, S1, D1, F1, A1).
...
Mirror #124: once numbers exist, add a `doc/work/2.0/post-124-ui-rollup.md` (build-order checklist by
