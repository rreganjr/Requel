...
`doc/work/2.0/132-reactive-forms-plan.md` §2.3, which is the closest thing #171 currently has to a spec.
...
- The five wizard editors (#173: project, actor, stakeholder, scenario, use-case) are still
  ...
  invent its own. Add a line to `doc/work/2.0/132-reactive-forms-plan.md` §2.2's table pointing `n` at the
...
> `doc/work/2.0/171-bean-validation-plan.md`.
>
