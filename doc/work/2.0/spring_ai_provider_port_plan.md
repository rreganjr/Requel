...
> Implements `doc/work/2.0/issue_spring_ai_provider_clients.md`. Background/worked example:
> `doc/work/2.0/port-tospring-boot-ai.md` §1. Follow-on to #43; depends on the Spring Boot 3.5.14 +
...
- `doc/guides/AI_ASSISTANT_SETUP.md`: OpenAI hosted + local base-url config; note Anthropic + native
