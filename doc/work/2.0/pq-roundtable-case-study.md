...
Its conclusions drive `doc/work/backlog/ai-per-type-assistants-epic.md`. Where that spec asserts something about
...
Folded into `doc/work/backlog/ai-per-type-assistants-epic.md`:
...
- **Provenance has no home.** Tags were used for it and their limits are now measured, not guessed —
  see `doc/work/backlog/entity-provenance-notes.md`.
- **`GoalRelationType` has only `Supports` and `Conflicts`,** so `PROXY_FOR_OUTCOME` and
  ...
  `doc/work/backlog/goal-relation-types-proposal.md`.
...
- **Tag names and values are silently lower-cased** — see `doc/work/backlog/entity-provenance-notes.md`.
...
`doc/work/2.0/roundtable/pq-roundtable-emitted-CON-3685.md` holds the first generated ticket and its analysis. The short
...
condition. This joins the Goal vocabulary in `doc/work/backlog/ai-per-type-assistants-epic.md`.
...
`doc/work/2.0/roundtable/pq-roundtable-emitted-CON-3685-v2.md` re-emits the ticket from the three-source model and diffs
...
- Re-emit CON-3685 now that three sources are in the model, and compare against the first emission in
  `doc/work/2.0/roundtable/pq-roundtable-emitted-CON-3685.md` — the first real test of the living document.
