...
2. **No-op fallback factory**
   ...
   - Once the assistant SPI from `doc/work/2.0/assistant-spi-plan.md` lands, this no-op contract is also what backs the SPI's "explicit empty `AssistantResult`" rule for disabled assistants.
...
> Phase 4.5 — see `doc/work/2.0/43-phase-4.5-plan.md`, Completion section). Scope 2 (absent-module
