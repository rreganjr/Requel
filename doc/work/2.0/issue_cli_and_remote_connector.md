...
`doc/guides/local_mcp_bridge.md`. Depends on the Command Gateway ticket (series ticket 1).
...
>   `gateway-rest-client`). **Implementation plan: `doc/work/2.0/70-requel-cli-plan.md`.**
