...
Design rationale and model: see `doc/architecture/project-entity-categorization.md`.
...
- Update `doc/architecture/MODULARIZATION_PLAN.md` with the new module pair and dependency edges.
- Keep `doc/architecture/project-entity-categorization.md` in sync if the model changes during implementation.
