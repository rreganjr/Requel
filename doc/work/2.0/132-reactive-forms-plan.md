...
Part of the UI/UX remediation epic #124. Source: `doc/work/2.0/UI_UX_REVIEW.md` Finding 3.1. Phase 3.
...
9. **Split three ways; #132 stays at 8.** `doc/work/2.0/158-form-wizard-field.md` §7 repointed #132 to
...
`doc/work/2.0/158-form-wizard-field.md` §2 established the rule: capture `id` **and** `version` from
...
- [ ] Held `version` is refreshed from the command result after **every** step commit, not just
      ...
      `@Version`, so the Goal/Story precedent in `doc/work/2.0/158-form-wizard-field.md` §2 does not
      carry over.
