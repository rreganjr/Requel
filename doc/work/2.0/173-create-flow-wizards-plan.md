...
Companion to `doc/work/2.0/132-reactive-forms-plan.md` (§1.1 step tables, §3 version contract, §10.3
acceptance criteria) and `doc/work/2.0/158-form-wizard-field.md` (§2 version rule, the `app-form-wizard` API).
...
- **§3 should be corrected in `doc/work/2.0/132-reactive-forms-plan.md`** as well as on the ticket, or the
