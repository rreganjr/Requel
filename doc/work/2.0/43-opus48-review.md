...
Reviewer pass against `doc/work/2.0/assistant-spi-plan.md`, `doc/work/2.0/ai-assistance-plan.md`, and
`doc/work/2.0/nlp-optional-plan.md`. Scope: confirm "Phase 4 and earlier" is in good shape
