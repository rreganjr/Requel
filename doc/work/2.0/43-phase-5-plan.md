...
This doc consolidates the fine-grained slices; the master `doc/work/2.0/ai-assistance-plan.md`
(Phase 5) and `doc/work/2.0/assistant-spi-plan.md` remain the design references.
