...
reviewed. The full record is in `doc/work/2.0/pq-roundtable-case-study.md`; the results are what the scope
...
- `doc/guides/AI_ASSISTANT_SETUP.md`: a clearly-labelled **development-only** section stating this drives an
...
- Note in `doc/guides/AI_ASSISTANT_SETUP.md` that AI detection of PII is not a substitute for this: sending
