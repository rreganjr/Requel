...
Found while building the **PlatformQ Roundtable** project (`doc/work/2.0/pq-roundtable-case-study.md`):
...
`doc/work/backlog/ai-per-type-assistants-epic.md`, which is worth spelling out because the two look alike.
