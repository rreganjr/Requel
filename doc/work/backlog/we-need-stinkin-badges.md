...
- `doc/work/2.0/20-release-plan.md` — release orchestration and CI rationale
- `doc/work/2.0/RELEASE_20_TEST_PLAN.md` — backend/frontend/E2E test inventory
- `doc/work/backlog/e2e-coverage-improvement-plan.md` — current frontend coverage targets
- `doc/guides/RELEASE_GUIDE.md` — manual release runbook
