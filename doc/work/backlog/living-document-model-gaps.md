...
Relates to #43. Where `doc/work/backlog/ai-per-type-assistants-epic.md` makes the *analysis* better, this epic
...
`doc/work/2.0/pq-roundtable-case-study.md` is the record. Nothing is speculative.
...
5. **Entity provenance** — spec in `doc/work/backlog/entity-provenance-notes.md`.
...
`doc/work/backlog/goal-relation-types-proposal.md` is deliberately *not* a child here — it is a small,
...
Full analysis in `doc/work/backlog/entity-provenance-notes.md`: why tags were used for the roundtable ingest,
