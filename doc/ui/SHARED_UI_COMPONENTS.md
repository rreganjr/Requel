...
component-layer companion to `doc/ui/UI_DESIGN_GUIDE.md` — that guide covers the *visual* system
...
It was written as the consolidation capstone of the look-and-feel epic (`doc/work/2.0/124-remediation-rollup.md`,
...
- `doc/ui/UI_DESIGN_GUIDE.md` — the visual system (layout, color, typography, spacing, PrimeNG config).
- `doc/work/2.0/124-remediation-rollup.md` — the epic rollup and per-ticket plans.
...
- `doc/architecture/AUTH_ARCH.md` — the authorization model the command hosts rely on.
