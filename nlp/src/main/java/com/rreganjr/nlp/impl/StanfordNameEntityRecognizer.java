...
public class StanfordNameEntityRecognizer implements NLPProcessor<NLPText> {
	private static final Log log = LogFactory.getLog(StanfordNameEntityRecognizer.class);
	...
	static {
		try {
			...
			log.error("Failed to initialize named entity recognizer.", e);
			classifier = null;
//			throw new ExceptionInInitializerError(e);
	...
	private synchronized void ner(NLPText text) throws ParserException {
		...
		for (CoreLabel label : classifier.classifySentence(tokens)) {
