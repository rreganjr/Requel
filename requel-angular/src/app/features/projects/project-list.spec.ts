...
const MOCK_PROJECTS = [
  { id: 1, version: 0, name: 'Alpha', description: null, organizationName: 'Acme',
    ...
    actorCount: 0, scenarioCount: 0, useCaseCount: 0, glossaryTermCount: 0, reportGeneratorCount: 0, dictionaryWordCount: 0, canDelete: true },
  { id: 2, version: 0, name: 'Beta', description: null, organizationName: null,
    ...
    actorCount: 0, scenarioCount: 0, useCaseCount: 0, glossaryTermCount: 0, reportGeneratorCount: 0, dictionaryWordCount: 0, canDelete: false }
];
