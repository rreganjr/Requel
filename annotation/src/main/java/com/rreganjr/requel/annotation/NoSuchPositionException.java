...
public class NoSuchPositionException extends NoSuchEntityException {
	 ...
	 * @return
	 */
	public static NoSuchPositionException forAddingWordToGlossary(/*ProjectOrDomain*/ Object pod, String word) {
		return new NoSuchPositionException(Position.class, null, "word", word,
	 ...
	 * @return
	 */
	public static NoSuchPositionException forAddingActorToProject(/*ProjectOrDomain*/ Object pod,
			String actorName) {
